...
def patch_cache_lfu(lock_obj):
    ...
    """
    import CodernityDB3.lfu_cache
    import CodernityDB3.lfu_cache_with_lock
    lfu_lock1lvl = CodernityDB3.lfu_cache_with_lock.create_cache1lvl(lock_obj)
    lfu_lock2lvl = CodernityDB3.lfu_cache_with_lock.create_cache2lvl(lock_obj)
    __patch(CodernityDB3.lfu_cache, 'cache1lvl', lfu_lock1lvl)
    __patch(CodernityDB3.lfu_cache, 'cache2lvl', lfu_lock2lvl)
...
def patch_cache_rr(lock_obj):
    ...
    """
    import CodernityDB3.rr_cache
    import CodernityDB3.rr_cache_with_lock
    rr_lock1lvl = CodernityDB3.rr_cache_with_lock.create_cache1lvl(lock_obj)
    rr_lock2lvl = CodernityDB3.rr_cache_with_lock.create_cache2lvl(lock_obj)
    __patch(CodernityDB3.rr_cache, 'cache1lvl', rr_lock1lvl)
    __patch(CodernityDB3.rr_cache, 'cache2lvl', rr_lock2lvl)
